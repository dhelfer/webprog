...
alter table sc_event add constraint sc_event_sc_subcategory foreign key (subCategoryId) references sc_subcategory (subCategoryId);
alter table sc_event add constraint sc_event_sc_venue foreign key (venueId) references sc_venue (venueId);
